...
public class GadgetContentResource extends IdentifiableResource
{
   public static final String LINK_REL = "gatein.content.gadgets";
   
   protected String referenceURI;
   protected String uri;
   
   @XmlElement(name="reference-uri")
